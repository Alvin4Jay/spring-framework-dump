...
public abstract class FactoryBeanRegistrySupport extends DefaultSingletonBeanRegistry {
	...
	// FactoryBean名字--->FactoryBean.getObject()创建的Bean实例
	...
	protected Object getCachedObjectForFactoryBean(String beanName) {
		return this.factoryBeanObjectCache.get(beanName); // 检查缓存
	}

	/**
	 * Obtain an object to expose from the given FactoryBean. 从FactoryBean获取对象 getObject
				...
				if (object == null) {
					...
					if (alreadyThere != null) {
						...
						if (shouldPostProcess) {
							...
							try {
								// 应用后置处理 AbstractAutowireCapableBeanFactory.postProcessObjectFromFactoryBean
